...
select * from orders  
where salesman_id =(select distinct salesman_id from orders where c.customer_id = 3007);
...
group by grade having grade>(select avg(grade) from customers city='New York');
...
select a.salesman_id, a.salesman_name, order_no, order_date, purchase_amount from salesman a, orders b 
where a.salesman_id = b.salesman_id 
